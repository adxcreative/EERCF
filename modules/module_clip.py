...
class CLIP(nn.Module):
    ...
    def get_config(pretrained_clip_name="ViT-B/32"):
        model_path = os.path.join("/data/tiankaibin/Text2VideoDataset", "ViT-B-32.pt") #os.path.dirname(os.path.abspath(__file__))
        if pretrained_clip_name in _MODELS and pretrained_clip_name in _PT_NAME:
            model_path = os.path.join("/data/tiankaibin/Text2VideoDataset", _PT_NAME[pretrained_clip_name])
